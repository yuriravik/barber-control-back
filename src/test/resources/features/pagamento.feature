...
Funcionalidade: Gerenciamento de Pagamentos
  ...
  Contexto:
    ...
    E que existe um barbeiro de pagamento com nome "Barbeiro Pgto", especialidade "Barba" e comissão 25
    E que existe um serviço de pagamento com nome "Serviço Pgto", preço 60 e duração 45 minutos
  ...
  Cenário: Registrar um pagamento com sucesso via PIX
    ...
    Quando eu registro um pagamento para o agendamento criado com valor 60 e forma de pagamento "PIX"
  ...
  Cenário: Registrar um pagamento com cartão
    ...
    Quando eu registro um pagamento para o agendamento criado com valor 60 e forma de pagamento "CARTAO"
    Então o status da resposta deve ser 201
  ...
  Cenário: Registrar um pagamento em dinheiro
    ...
    Quando eu registro um pagamento para o agendamento criado com valor 60 e forma de pagamento "DINHEIRO"
    Então o status da resposta deve ser 201
  ...
  Cenário: Não deve registrar pagamento duplicado para o mesmo agendamento
    ...
    E que já existe um pagamento registrado para o agendamento criado com valor 60 e forma "PIX"
    Quando eu registro um pagamento para o agendamento criado com valor 60 e forma de pagamento "PIX"
    Então o status da resposta deve ser 422

  Cenário: Não deve registrar pagamento para agendamento inexistente
    Quando eu registro um pagamento para o agendamentoId "00000000-0000-0000-0000-000000000099" com valor 60 e forma de pagamento "PIX"
  ...
  Cenário: Listar pagamentos com sucesso
    ...
    E que já existe um pagamento registrado para o agendamento criado com valor 60 e forma "DINHEIRO"
  ...
  Cenário: Buscar pagamento por ID com sucesso
    ...
    E que já existe um pagamento registrado para o agendamento criado com valor 60 e forma "CARTAO"
