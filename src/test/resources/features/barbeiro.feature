...
Funcionalidade: Gerenciamento de Barbeiros
  ...
  Cenário: Criar um novo barbeiro com sucesso
    Quando eu crio um barbeiro com nome "Carlos Barbeiro", especialidade "Corte Degradê" e percentual de comissão 30
  ...
  Cenário: Criar barbeiro sem especialidade
    Quando eu crio um barbeiro com nome "Barbeiro Simples" e percentual de comissão 25 sem especialidade
    Então o status da resposta deve ser 201
    E o campo "nome" da resposta deve ser "Barbeiro Simples"

  Cenário: Não deve criar barbeiro sem nome
    Quando eu crio um barbeiro sem nome com percentual de comissão 20
    Então o status da resposta deve ser 400

  Cenário: Não deve criar barbeiro com percentual de comissão negativo
    Quando eu crio um barbeiro com nome "Inválido", especialidade "Nenhuma" e percentual de comissão -1
    Então o status da resposta deve ser 400

  Cenário: Não deve criar barbeiro com percentual de comissão acima de 100
    Quando eu crio um barbeiro com nome "Inválido", especialidade "Nenhuma" e percentual de comissão 101
    Então o status da resposta deve ser 400

  Cenário: Listar barbeiros do usuário autenticado
    Dado que existe um barbeiro criado com nome "Barbeiro Listagem", especialidade "Barba" e comissão 20
    Quando eu listo os barbeiros
    Então o status da resposta deve ser 200
    E a resposta deve ser uma lista

  Cenário: Desativar barbeiro com sucesso
    Dado que existe um barbeiro criado com nome "Barbeiro Desativar", especialidade "Corte" e comissão 15
