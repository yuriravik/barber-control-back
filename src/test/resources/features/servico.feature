...
Funcionalidade: Gerenciamento de Serviços
  ...
  Cenário: Criar um novo serviço com sucesso
    Quando eu crio um serviço com nome "Corte Simples", descrição "Corte de cabelo simples", preço 35.00 e duração 30 minutos
  ...
  Cenário: Criar serviço sem descrição
    Quando eu crio um serviço com nome "Serviço Básico", preço 20.00 e duração 20 minutos sem descrição
    Então o status da resposta deve ser 201
    E o campo "nome" da resposta deve ser "Serviço Básico"

  Cenário: Não deve criar serviço sem nome
    Quando eu crio um serviço sem nome com preço 30.00 e duração 30 minutos
    Então o status da resposta deve ser 400

  Cenário: Não deve criar serviço com preço zero
    Quando eu crio um serviço com nome "Grátis", descrição "Teste", preço 0.00 e duração 30 minutos
    Então o status da resposta deve ser 400

  Cenário: Não deve criar serviço com duração zero
    Quando eu crio um serviço com nome "Teste", descrição "Teste", preço 30.00 e duração 0 minutos
    Então o status da resposta deve ser 400

  Cenário: Listar serviços do usuário autenticado
    Dado que existe um serviço criado com nome "Serviço Listagem", preço 45.00 e duração 45 minutos
    Quando eu listo os serviços
    Então o status da resposta deve ser 200
    E a resposta deve ser uma lista

  Cenário: Buscar serviço por ID com sucesso
    Dado que existe um serviço criado com nome "Serviço Busca", preço 50.00 e duração 60 minutos
  ...
  Cenário: Deletar serviço com sucesso
    Dado que existe um serviço criado com nome "Serviço Delete", preço 25.00 e duração 15 minutos
